...
**A1.** The committee that spent the most on Facebook was Peter Franchot at $57,928, followed by another Franchot group and Jain Ashwani.
...
media_expenses_clustered <- read_csv("data/media-expenses-csv.csv") |> clean_names()


media_expenses_clustered |> filter(payee_name == "Facebook") |>
...
Franchot ran for governor of Maryland in 2022; Jain ran for US House and lost in 2024; Boniface ran for election to the Harford County Executive in 2022; Jon Baron ran for governor of Maryland in 2022. All of Franchot's ads say they are inactive and "didn’t follow our policy for ads about social issues, elections or politics." However, I notice that his campaign spent anywhere between $200 and $6,000 on individual ads, most of them had between 60 and 70,000 impressions and were up for 2-4 weeks.
...
**A3.** Wes Moore, who won the democratic primary for governor, is notably missing from the list. It looks like his campaign ran Facebook ads according to the library, however perhaps less frequently and less expensive than Franchot. Moore's campaign is the biggest recipient of media expenses from "SKDK."

```{r}
media_expenses_clustered |>
  filter(str_detect(committee_name, "Moore Miller for Maryland Slate | Moore  Wes For Maryland")) |>
...
**A4.** It's a similar list to the first question about top Facebook spenders. It appears the Franchot committees spent all of their online ad dollars on Facebook, but not Jain.
...
**A5** The best story from here is that we don't know exactly what Wes Moore's committee spend their media expenses on. They gave well north of $1 million to SKDK, which appears to be a D.C.-based political consulting firm, but we don't know how any of that money was actually spent. I'd be curious to dig into that story and see how Moore's campaign was able to get ahead of its competitors through their use of advertising money versus, say, just paying directly for ads on Facebook.
