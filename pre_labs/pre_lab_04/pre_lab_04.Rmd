...
**Task** Run the following code to use the n_gram_merge() function to clean the data, then group by grantee_clean and Grantee to examine recipients that start with W. Look at the differences. Does the changes it made vary substantially from the previous use of key_collision_merge? **Answer It varies a decent amount from the key_collision_merge, for example adding periods at the end of abbreviations like "ASSOC." and "CO." n_gram_merge() also changed the order of Wayne M Holland's name to put the middle initial between his first and last name, and it spells as "RC&D" as "RESOURCE CONSERVATION AND..."**
