...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer This is a chart showing total weekly 911 calls. The x-axis is still not visually pretty, but much more readable than Task 14 because of the 45-degree rotation. As far as the call numbers, we see great fluctuation week to week.**
