...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer** 8 columns: Object ID, zip name, zipcode 1, zip code 2, existing, shape_leng, shape_area, geometry
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer** It says what zip code each object is in, as well as the town and other info.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This is a map of the state of Maryland broken down into zip codes, and the x and y-axis show latitude and longitude.
...
**Task** Run the following code. Describe the output in the space below. **Answer** There are 19 columns and 3,235 rows.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This code filtered all US counties to just include ones in Maryland. The output showed all 24 counties in the state.
...
**Task** Run the following code. Describe the output in the space below. **Answer** Still on a longitude-latitude scale, this map is less broken up than the zip code one and is split by county,
...
**Task** Run the following code. Describe the output in the space below. **Answer** This map shows the zip code boundaries layered on top of the county lines.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This shows notices of intent to foreclosure in March 2023 in every Maryland zip code.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This joins in the zip code shapes with the foreclosure data, showing the number of intents to foreclose in each zip code.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This map adds color to show which zip codes have the most foreclosures vs. the least.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This shows the population data in each county and the number of notices in each county
...
**Task** Run the following code. Describe the output in the space below. **Answer** This shows the geometry information for each zip code's boundaries along with the population estimate.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This is a table showing the population data and the foreclosure data, but the names of the counties aren't under the same format in each table.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This standardizes the name column, having it just be called "county" while removing the Maryland at the end of the title and putting it in titlecase. It also simplifies the population column so that the chart only has 3 variables.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This shows the foreclosure data along with the population data in a clean table.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This sorts the foreclosure notices from highest to lowest.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This visualizes the data with a choropleth map, coloring each county based on its rate of notices of foreclosure per 1,000 people.
...
**Task** Run the following code. Describe the output in the space below. **Answer** This applies magma color to make the county lines more readable.
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer** This chart enhances the ability to see the differences in rates between smaller counties with the log scale. Regionally, I notice that there are higher rates of foreclosure in the Baltimore area and around southern Maryland.
