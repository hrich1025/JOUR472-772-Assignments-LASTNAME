...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer** I think it's interesting that "patient" has a positive sentiment because that word could be used in the context of a medical patient, which might have an inherently negative meaning. In addition, while "limited" naturally seems like a negative word, it could also be used in the context of seeing a limited crime sentence or facing limited issues, which would then make it a positive connotation.
